...
export default function RobloxSprite({
  ...
  // Animated WebP built via img2webp (libwebp), which defaults to
  // dispose=BACKGROUND so frames replace cleanly with no stacking.
  const imgSrc = src.replace(/\.(webm|mp4|png)$/, '.webp');
